...
<#
foreach($p in Get-BPAllUserPaths) {
    Write-Output($p)
}
#>
...
#region BP's Instructions
# The instructions, in order, that BP wants us to follow (plus some extra things I wanted to add to the script)
...
# 9.Z Log what was set, and whether it was changed
